...
### Reputation
- `agora reputation commit <prediction> --domain <domain> [--expiry <ms>]` — Commit to a prediction
- `agora reputation reveal <prediction> --commit-id <id> --outcome <outcome> [--evidence <url>]` — Reveal prediction and outcome
...
- `agora reputation query --agent <pubkey> --domain <domain>` — Query trust score for an agent in a domain
